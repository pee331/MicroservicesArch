// src/lib.rs
/*
 * Core library for MicroservicesArch
 */
...
#[derive(Debug)]
pub struct MicroservicesArchProcessor {
    verbose: bool,
    processed_count: usize,
}

impl MicroservicesArchProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting MicroservicesArch processing");
    
    let mut processor = MicroservicesArchProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = MicroservicesArchProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = MicroservicesArchProcessor::new(false);
